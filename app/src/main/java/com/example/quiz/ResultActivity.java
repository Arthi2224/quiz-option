...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.append("Correct answer:").append(QuestionActivity.correct).append("\n");

        StringBuffer sb2 = new StringBuffer();
        sb2.append("Wrong answer:").append(QuestionActivity.wrong).append("\n");

        StringBuffer sb3 = new StringBuffer();
        sb3.append("Final Score:").append(QuestionActivity.correct).append("\n");


        StringBuffer sb4 = new StringBuffer();
        sb4.append(QuestionActivity.correct).append("/").append("5");
