...
public class ResultActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb.append("Correct answer:").append(QuestionActivity2.correct).append("\n");

        StringBuffer sb2 = new StringBuffer();
        sb2.append("Wrong answer:").append(QuestionActivity2.wrong).append("\n");



        StringBuffer sb3 = new StringBuffer();
        sb3.append("Final Score:").append(QuestionActivity2.correct).append("\n");


        StringBuffer sb4 = new StringBuffer();
        sb4.append(QuestionActivity2.correct).append("/").append("5");
